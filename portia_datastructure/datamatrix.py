...
class DataMatrix:
	...
	def get_list_of_list(
			self,
			append_attribute_labels: bool = True,
			append_classlabels: bool = True
	) -> List[Union[List[str], List[float]]]:
